...
'		</div>'].join("");
    ...
    function initAnalogData(result) {
        ...
        {
            var data_obj = {};
            data_obj["name"] = cunzhuangArr[i*10];
            data_obj["yl"] = result[i*10+1];
            data_obj["kqwd"] = result[i * 10 + 2];
            data_obj["kqsd"] = result[i * 10 + 3];
            data_obj["dqy"] = result[i * 10 + 4];
            data_obj["fs"] = result[i * 10 + 5];
            data_obj["fx"] = "东南";
            data.push(data_obj);
        }
    }
