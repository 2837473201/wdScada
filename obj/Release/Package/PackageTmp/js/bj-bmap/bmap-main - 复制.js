...
$(function() {
	! function() {
		...
		var analogCityName1 = 0, analogCityName2 = 0, jibie = 13, boundary = "郑州市";
...
var overBeforeColor;
			...
			setTimeout(function () {
			    analogCurCity(analogCityName1, analogCityName2, jibie, boundary);
			}, 1000);
			
			var curpoint;
			function analogCurCity(a, b,c,d) {
			    console.log(a,b,"22222222222222244444444444444444");
			    curpoint = new BMap.Point(a, b);
			    console.log(curpoint,"44444444444444");
			   // map.centerAndZoom(curpoint, c); //郑州市113.666024,34.753162
			    getBoundary(d);
			    setTimeout(function () {
